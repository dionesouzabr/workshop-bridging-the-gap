...
![](https://github.com/dionesouzabr/workshop-bridging-the-gap/actions/workflows/0-start-workshop.yaml/badge.svg)
![](https://github.com/dionesouzabr/workshop-bridging-the-gap/actions/workflows/1-create-ruleset.yaml/badge.svg)
![](https://github.com/dionesouzabr/workshop-bridging-the-gap/actions/workflows/2-open-pr.yaml/badge.svg)
![](https://github.com/dionesouzabr/workshop-bridging-the-gap/actions/workflows/3-merge-pr.yaml/badge.svg)
...
4. Clique em **Start Workshop** e siga as instruções. Ao final do fluxo (merge do Pull Request), você terá um repositório completamente funcional em uma nova organização.
   ...
   <a id="start-workshop" href="https://github.com/dionesouzabr/workshop-bridging-the-gap/issues/1">
